$(function() {
  ...
  $(".q23 li:not([class='q23item'])").css("color", "red");
  ...
  $(".q43").next("p").css("color", "red");

  // 問題44:siblingsメソッド
  // siblingsメソッドを使い、クラスsecond以外の要素の文字の色を赤色に変えてください。
